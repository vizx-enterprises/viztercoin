...
**If self compiled, please provide of your VizterCoin CMake output at the default verbosity**:
```
...
**Binary Reported:** <!-- does this issue affect zedwallet, VizterCoind, vizter-service, miner? -->
