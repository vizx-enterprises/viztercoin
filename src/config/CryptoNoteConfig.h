...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const char GENESIS_COINBASE_TX_HEX[] = "011401ff0001b574029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd088071210133059a8e05b9daee9b417372c65a0ae794798b54db7464004b7e419e550c8f9c";
    ...
    const int P2P_DEFAULT_PORT = 3996;

    const int RPC_DEFAULT_PORT = 3997;
    ...
    const char LATEST_VERSION_URL[] = "https://github.com/vizx-enterprises/viztercoin/releases";

    const std::string LICENSE_URL = "https://github.com/vizx-enterprises/viztercoin/blob/master/LICENSE";

    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {0xb5, 0x0c, 0x4a, 0x6c, 0xcf, 0x73, 0x37, 0x45, 0x35, 0xf9, 0x71, 0xa4, 0xb8, 0xc1, 0x43, 0xe9}};

    const char *const SEED_NODES[] = {
        "185.8.177.12:3996" // volcano host 4gb ram
    };
} // namespace CryptoNote
